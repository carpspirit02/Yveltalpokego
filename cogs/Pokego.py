...
class Pokego(commands.Cog):
            ...
            if Name == "Mr" or Name == "Mr.":
                if content[2].lower() == "mime" or content[2].lower() == "rime" or content[2].lower() == "mime*" or content[2].lower() == "rime*":
                    ...
                    if content[2].lower() == "mime":
                        ...
                        embed.add_field(name="__Informations Générales:__", value="**-"+result[1]+"**\n-Taille/Poids: \n**"+result[3]+"m** / **"+result[4]+"kg**\n", inline=True)
                        embed.add_field(name="__Statistiques:__", value="-Max CP: **"+ result[5] +"**\n_(Lvl 50, 100% IV)_\n-Atk: **"+result[6]+"**\n-Def: **"+result[7]+"**\n-Sta: **"+result[8]+"**\n", inline=True)
                        embed.add_field(name="__Shiny:__",value="-<:pokemonshiny:802203463814873119>Shiny Dispo: **"+result[9]+"**\n-<:eggs:802203106863480833>Shiny Limité: **"+result[10]+"**\n-<:raids:802203461953126441>Shiny Raid: **"+result[11]+"**\n-<:raid12:802203480643076196>Shiny Oeuf: **"+result[12]+"**\n-<:etudesspeciales2:802203124358053928>Shiny Quête: **"+result[13]+"**\n",inline=True)
                        embed.add_field(name="__Attaques Rapide:__",value=""+result[14], inline=True)
                        embed.add_field(name="__Attaques Chargé:__",value=""+result[15], inline=True)
                        embed.add_field(name="__Vulnérabilité:__", value=result[17]+"\n**__Résistance__:**\n"+result[16], inline=True)
                        ...
                        embed.add_field(name="__Attaques Rapide:__",value=""+result[14], inline=True)
                        embed.add_field(name="__Attaques Chargé:__",value=""+result[15], inline=True)
                        embed.add_field(name="__Vulnérabilité__:", value=result[17]+"\n**__Résistance__:**\n"+result[16], inline=True)
                        embed.set_footer(text="Provided by Nexus-Z", icon_url="https://raw.githubusercontent.com/Sollisnexus/Sollisnexus.github.io/master/NexusZ/NexusZLogo_2.png")
                        candelete = await get_delete(self, ctx)
                        if candelete == "True":
                            await ctx.message.delete()
                    ...
                    if candelete == "True":
                        await ctx.message.delete()
                    await ctx.send('Ce Pokémon existe pas!')
            elif Name == "Mime":
                if content[2].endswith("*"):
                        isshiny = "Shiny"
                        Name = Name.replace("*", "")
                ...
                embed.set_thumbnail(url= "https://raw.githubusercontent.com/carpspirit02/Yveltalpokego/main/PokemonImages/"+str(isshiny)+"/"+Name+".png")
                embed.add_field(name="__Informations Générales:__", value="**-"+result[1]+"**\n-Taille/Poids: \n**"+result[3]+"m** / **"+result[4]+"kg**\n-Distance copain: **"+result[18]+"**", inline=True)
                embed.add_field(name="__Statistiques:__", value="-Max CP: **"+ result[5] +"**\n_(Lvl 50, 100% IV)_\n-Atk: **"+result[6]+"**\n-Def: **"+result[7]+"**\n-Sta: **"+result[8]+"**\n", inline=True)
                embed.add_field(name="__Shiny:__",value="-<:pokemonshiny:802203463814873119>Shiny Dispo: **"+result[9]+"**\n-<:eggs:802203106863480833>Shiny Limité: **"+result[10]+"**\n-<:raids:802203461953126441>Shiny Raid: **"+result[11]+"**\n-<:raid12:802203480643076196>Shiny Oeuf: **"+result[12]+"**\n-<:etudesspeciales2:802203124358053928>Shiny Quête: **"+result[13]+"**\n",inline=True)
                embed.add_field(name="__Attaques Rapide:__",value=""+result[14], inline=True)
                embed.add_field(name="__Attaques Chargé:__",value=""+result[15], inline=True)
                ...
                if tname == "Mewtwo":
                    ...
                    if candelete == "True":
                        await ctx.message.delete()
                    await ctx.send("Seul le Mewtwo Armure existe ...     Ţ̸̧̖̘̒͐͌e̷̳͕͋a̸̗̫̓ḿ̷̡͙̱̊̚ ̵̘̖̼̪̦̟̏̂̀̓͌͘͝R̴̨̨͈̰̼̳̜̓̈̓o̷͙͠c̶͔̼̀̍̄̃̔͝ķ̸̦̜͚͂̅̀e̶̡̢̡̘̜̒̕t̷͎̼̙̀͌̊̂̕̚")
            elif Name == "Origin":
                tname = content[2].capitalize()
                if content[2].endswith("*"):
                        isshiny = "Shiny"
                ...
                if tname == "Giratina":
                    ...
                    if candelete == "True":
                        await ctx.message.delete()
                    await ctx.send("Seule Giratina forme Originel existe ...")
            elif Name == "Wormadam":
                StName = "Wormadams"
                TrName = "Wormadamt"
                result = await dex(self, str(Name))
    ...
    async def alolan(self, ctx):
        ...
        if GaName in Listofalola:
            ...
            await ctx.send('Ce Pokémon Alola existe pas!')
    ...
    async def galarian(self, ctx):
        ...
        if GlName in Listofgalar:
            ...
            await ctx.send('Ce Pokémon de Galar existe pas!')
    ...
    async def gorocket(self, ctx):
        ...
        if name not in grunts:
            ...
            if name not in leaders:
                name = name + " Grunt"
            embed = discord.Embed(title= name+"'s Pokémon Obscur actuel et passé" , description="", color=0x2962FF)
    ...
    async def gotohome(self, ctx):
        ...
        if Name == namea:
            ...
            if GaName in Listofalola:
                ...
                embed.add_field(name="__Statistiques__ Given", value="Level: **"+str(Level)+"**  ATK: **"+str(GOATK)+"**  DEF: **"+str(GODEF)+"**  HP: **"+str(GOHP)+"**", inline=False)
                embed.set_footer(text="Provided by Nexus-Z", icon_url="https://raw.githubusercontent.com/Sollisnexus/Sollisnexus.github.io/master/NexusZ/NexusZLogo_2.png")
                candelete = await get_delete(self, ctx)
                if candelete == "True":
                    await ctx.message.delete()
